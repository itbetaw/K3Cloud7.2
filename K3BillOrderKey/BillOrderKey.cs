...
namespace Middleware.Target.Core.Models.K3Cloud7_2.K3BillOrderKey
{
    public class BillOrderKey
    {
        #region 财务会计 总账 
        ...
        public const string BalTypeNew = "PEA_SDXBalTypeNew";

        public const string BillTypeNew = "PEA_SDXBillTypeNew";

        public const string BusinessSysBillNew = "PEA_SDXBusinessSysBillNew";
