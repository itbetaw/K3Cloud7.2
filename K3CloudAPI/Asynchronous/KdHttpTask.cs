...
namespace Middleware.Target.Core.Models.K3Cloud7_2.K3CLoudAPI.Asynchronous
{
    /// <summary>
    ...
    public class KdHttpTask<T>
    {
        ...
        //{
        //    KdRequest.ExecuteAsync<T>(ExecuteSuccess, ProgressCallBack, ExecuteFail, Timeout, ReportInterval);
        //    this.IsRunning = true;
        //}//end method
        ...
        private void ExecuteFail(Exception ex)
        {
            //this.IsRunning = false;
