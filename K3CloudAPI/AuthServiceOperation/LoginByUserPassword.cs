...
namespace Middleware.Target.Core.Models.K3Cloud7_2.K3CLoudAPI.AuthServiceOperation
{
    /// <summary>
    /// 执行按用户名和密码登录操作。
    /// </summary>
    public class LoginByUserPassword : APIOperation
    {
        #region 公共覆盖操作参数
        ...
        public virtual LoginByUserPassword SetDBId(string dbId)
        {
            this.DBId = dbId;
            return this;
        }//end method
        ...
        /// <returns>返回类本身实例对象。</returns>
        public virtual LoginByUserPassword SetUserName(string userName)
        {
        ...
        /// <returns>返回类本身实例对象。</returns>
        public virtual LoginByUserPassword SetPassword(string password)
        {
        ...
        /// <returns>返回类本身实例对象。</returns>
        public virtual LoginByUserPassword SetUserLCID(int lcId)
        {
            this.UserLCID = lcId;
            return this;
        }//end method
        ...
        /// <returns>返回类本身实例对象。</returns>
        public virtual LoginByUserPassword SetUserLCID(CultureInfo culture)
        {
